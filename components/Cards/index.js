...
.then(response => {
  ...
  const items1 = response.data.articles.javascript;
  const items2 = response.data.articles.bootstrap;
  const items3 = response.data.articles.technology;
  const items4 = response.data.articles.jquery;
  const items5 = response.data.articles.node;


  console.log(items1, items2, items3, items4, items5);
  debugger
